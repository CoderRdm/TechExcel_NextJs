    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-bold mb-4">Resume Wizard</h3>
            <div className="mb-4">
             
            </div>
            <p className="text-gray-300 mb-2">Your trusted partner since 2025</p>
            <p className="text-gray-300">Jaipur ,Rajasthan 302018</p>
          ...
          <div>
            ...
            <ul>
              ...
              <li className="mb-2">
                <Link href="/Create-template" className="text-gray-300 hover:text-white transition-colors">
                  Services
                </Link>
              </li>
              <li className="mb-2">
                <Link href="/show" className="text-gray-300 hover:text-white transition-colors">
                  Products
                </Link>
              </li>
              <li className="mb-2">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">Email: goyalridam2005@gmail.com</p>
            <p className="text-gray-300 mb-4">Phone: (+91) 6367361810</p>
        ...
        <div className="border-t border-gray-700 mt-6 pt-6 text-center">
          <p className="text-gray-300">©2025 Nodal Express. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
