      ...
      {isMenuOpen && (
        <div className="md:hidden bg-black/80 backdrop-blur-xl border-b border-purple-500/50">
          <div className="px-2 pt-2 pb-4 space-y-1">
            <a href="/Create-template" className="block px-3 py-2 text-gray-300 hover:text-cyan-400 transition-all duration-300 hover:translate-x-2 font-medium">
